            ...
            <div class="row">
                <div class="col-12 col-lg-8 m-auto">
                    <form class="multisteps-form__form mb-8" style="height: 408px;"
                        action="{{ route('major.update', $majorModel) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="row mt-3">
                                    <div class="col">
                                        ...
                                        <select name="department_id" id="department_id"
                                            ...
                                            <option {{ ($majorModel->department_id == $department->id) ? 'selected' : ''
                                ...
                                <div class="row mt-3">
                                    <div class="col-12">
                                        ...
                                        <input class="multisteps-form__input form-control" type="text"
                                            placeholder="eg. Michael" name="name" value="{{ $majorModel->name ?? '' }}">
                                        @error('name')
                                        <div class="alert alert-danger" style="padding: 1% 0 0 2%; margin-top: 2%;">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 col-sm-6 mt-3 mt-sm-0 d-flex">
                                        ...
                                        <div class="form-check form-switch my-auto">
                                            <input class="form-check-input" {{ $majorModel->activated ? 'checked' : ''
                                            }}
