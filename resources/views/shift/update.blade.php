            ...
            <div class="row">
                <div class="col-12 col-lg-8 m-auto">
                    <form class="multisteps-form__form mb-8" style="height: 408px;"
                        action="{{ route('shift.update', $shiftModel) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="row mt-3">
                                    <div class="col-12">
                                        ...
                                        <input class="multisteps-form__input form-control" type="text"
                                            placeholder="eg. Michael" name="title"
                                            value="{{ $shiftModel->title ?? '' }}">
                                        @error('title')
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <input class="multisteps-form__input form-control" type="time" name="time_start"
                                            value="{{ date('H:i', strtotime($shiftModel->time_start )) ?? '' }}">
                                        @error('time_start')
                                        <div class="alert alert-danger" style="padding: 1% 0 0 2%; margin-top: 2%;">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <input class="multisteps-form__input form-control" type="time" name="time_end"
                                            value="{{ date('H:i', strtotime($shiftModel->time_end )) ?? '' }}">
                                        @error('time_end')
                                        <div class="alert alert-danger" style="padding: 1% 0 0 2%; margin-top: 2%;">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 col-sm-6 mt-3 mt-sm-0 d-flex">
                                        ...
                                        <div class="form-check form-switch my-auto">
                                            <input class="form-check-input" {{ $shiftModel->activated ? 'checked' : ''
                                            }}
