            ...
            <div class="row">
                <div class="col-12 col-lg-8 m-auto">
                    <form class="multisteps-form__form mb-8" style="height: 408px;"
                        action="{{ route('teacher.update', $teacherModel) }}" method="POST"
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="female"
                                                        name="gender" value="0" {{ ($teacherModel->gender == 0 || '') ?
                                                    'checked' : '' }}>
                                                </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="male" name="gender"
                                                        {{ ($teacherModel->gender == 1 ) ? 'checked' : '' }} value="1">
                                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <input class="multisteps-form__input form-control" type="date"
                                            ...
                                            value="{{ date('Y-m-d', strtotime($teacherModel->birthdate)) ?? '' }}">
                                        @error('birthdate')
                                        <div class="alert alert-danger" style="padding: 1% 0 0 2%; margin-top: 2%;">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                        ...
                                        <select name="level" id="level" class="multisteps-form__input form-control">
                                            ...
                                            <option value="1" {{ ($teacherModel->getInfoLogin->level == 1) ? 'selected'
                                                :
                                                ''
                                                }}>
                                                Giáo vụ
                                            </option>
                                            <option {{ ($teacherModel->getInfoLogin->level == 2) ? 'selected' : '' }}
                                                value="2">Giảng viên
                                            </option>
                                        </select>
                                        @error('level')
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                        ...
                                        <input class="multisteps-form__input form-control" type="email"
                                            ...
                                            value="{{ $teacherModel->getInfoLogin->email ?? '' }}">
                                        @error('email')
                                        <div class="alert alert-danger" style="padding: 1% 0 0 2%; margin-top: 2%;">
                                            {{ $message }}
                                        </div>
...
<script>
    preview();
    getAddress({{ $teacherModel->city_id ?? '-1' }}, {{ $teacherModel->district_id ?? '-1' }}, {{ $teacherModel->ward_id ?? '-1' }});
</script>
@endpush