            ...
            <div class="row">
                <div class="col-12 col-lg-8 m-auto">
                    <form class="multisteps-form__form mb-8" style="height: 408px;"
                        action="{{ route('examSchedule.update', $examScheduleModel) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="col-12 ">
                                        ...
                                        <select name="subject_id" id="subject_id"
                                            ...
                                            @foreach ($subjects as $subject)
                                                <option {{($examScheduleModel->subject_id == $subject->id) ? 'selected' : ''}}
                                                    value="{{$subject->id}}">
                                                    {{$subject->name}}
                                                </option>
                                            @endforeach
                                    ...
                                    <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                        ...
                                        <select name="department_id" id="department_id"
                                            ...
                                            @foreach ($departments as $department)
                                                <option {{($examScheduleModel->department_id == $department->id) ? 'selected' : ''}}
                                                    value="{{$department->id}}">
                                                    {{$department->name}}
                                                </option>
                                            @endforeach
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="radio" value="1"
                                                        id="di_hoc" name="type" {{($examScheduleModel->type == 1) ? 'checked' : ''}}
                                                        >
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="radio" value="0"
                                                        id="di_hoc" name="type" {{($examScheduleModel->type == 0) ? 'checked' : ''}}
                                                        >
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <select name="teacher_id" id="teacher_id"
                                            ...
                                            @foreach ($teachers as $teacher)
                                                <option {{($examScheduleModel->teacher_id == $teacher->id) ? 'selected' : ''}}
                                                    value="{{$teacher->id}}">
                                                    {{$teacher->fullname}}
                                                </option>
                                            @endforeach
                                    ...
                                    <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                        ...
                                        <input class="multisteps-form__input form-control" type="date"
                                             name="date"
                                            value="{{ date('Y-m-d', strtotime($examScheduleModel->date )) ??  "" }}">
                                        @error('date')
                                        <div class="alert alert-danger" style="padding: 1% 0 0 2%; margin-top: 2%;">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                        ...
                                        <select name="timestart" id="timestart"
                                            ...
                                            <option 
                                                value="{{ $value }}" 
                                                @if ($value === $examScheduleModel->timestart) 
                                                    selected  
                                                @endif 
                                               >
                                                {{$option}}
                                    ...
                                    <div class="col-12 col-sm-6 ">
                                        ...
                                        <select name="minutes" id="minutes"
                                            ...
                                            <option value="{{ $value }}" 
                                                @if ($value === $examScheduleModel->minutes) 
                                                    selected  
                                                @endif 
                                                >
                                                {{$option}}
